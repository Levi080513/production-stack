...
async def route_chat_completion_workspace(
...
async def route_completion_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_general_request(
        request,
...
async def route_embeddings_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_general_request(
        request,
...
async def route_tokenize_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_general_request(
        request, "/tokenize", background_tasks, workspace=workspace, endpoint_name=endpoint
    )


@main_router.post("/{workspace}/{endpoint}/detokenize")
async def route_detokenize_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_general_request(
        request,
...
async def route_v1_rerank_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_general_request(
        request, "/v1/rerank", background_tasks, workspace=workspace, endpoint_name=endpoint
    )


@main_router.post("/{workspace}/{endpoint}/rerank")
async def route_rerank_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_general_request(
        request, "/rerank", background_tasks, workspace=workspace, endpoint_name=endpoint
    )


@main_router.post("/{workspace}/{endpoint}/v1/score")
async def route_v1_score_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_general_request(
        request, "/v1/score", background_tasks, workspace=workspace, endpoint_name=endpoint
    )


@main_router.post("/{workspace}/{endpoint}/score")
async def route_score_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_general_request(
        request, "/score", background_tasks, workspace=workspace, endpoint_name=endpoint
    )


@main_router.post("/{workspace}/{endpoint}/sleep")
async def route_sleep_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_sleep_wakeup_request(
        request, "/sleep", background_tasks, workspace=workspace, endpoint_name=endpoint
    )


@main_router.post("/{workspace}/{endpoint}/wake_up")
async def route_wake_up_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_sleep_wakeup_request(
        request, "/wake_up", background_tasks, workspace=workspace, endpoint_name=endpoint
    )


@main_router.get("/{workspace}/{endpoint}/is_sleeping")
async def route_is_sleeping_workspace(
    workspace: str, endpoint: str, request: Request, background_tasks: BackgroundTasks
):
    return await route_sleep_wakeup_request(
        request,
...
async def route_completion(
    ...
    return await route_general_request(
        request,
        "/{workspace}/{endpoint}/v1/completions",
        background_tasks,
        workspace,
        endpoint,
    )
...
async def route_embeddings(
    ...
    return await route_general_request(
        request,
        "/{workspace}/{endpoint}/v1/embeddings",
        background_tasks,
        workspace,
        endpoint,
    )
...
async def route_tokenize(
    ...
    return await route_general_request(
        request, "/{workspace}/{endpoint}/tokenize", background_tasks, workspace, endpoint
    )
...
async def route_v1_rerank(
    ...
    return await route_general_request(
        request, "/{workspace}/{endpoint}/v1/rerank", background_tasks, workspace, endpoint
    )
...
async def route_rerank(
    ...
    return await route_general_request(
        request, "/{workspace}/{endpoint}/rerank", background_tasks, workspace, endpoint
    )
...
async def route_v1_score(
    ...
    return await route_general_request(
        request, "/{workspace}/{endpoint}/v1/score", background_tasks, workspace, endpoint
    )
...
async def route_score(
    ...
    return await route_general_request(
        request, "/{workspace}/{endpoint}/score", background_tasks, workspace, endpoint
    )
...
async def route_sleep(
    ...
    return await route_sleep_wakeup_request(
        request, "/{workspace}/{endpoint}/sleep", background_tasks, workspace, endpoint
    )
...
async def route_wake_up(
    ...
    return await route_sleep_wakeup_request(
        request, "/{workspace}/{endpoint}/wake_up", background_tasks, workspace, endpoint
    )
...
async def route_is_sleeping(
    ...
    return await route_sleep_wakeup_request(
        request,
        "/{workspace}/{endpoint}/is_sleeping",
        background_tasks,
        workspace,
        endpoint,
    )
...
async def endpoint_health(workspace: str, endpoint: str) -> Response:
    ...
    return JSONResponse(
        content={"status": f"Endpoint {workspace}/{endpoint} not found."}, status_code=404
    )
