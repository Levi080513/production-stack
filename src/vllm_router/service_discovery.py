...
class K8sPodIPServiceDiscovery(ServiceDiscovery):
    ...
    def _add_engine(
        self, engine_name: str, engine_ip: str, model_names: List[str], model_label: str, workspace: str, endpoint: str, routing_logic: str
    ):
        logger.info(
    ...
    def  _on_engine_update(
        ...
        if event == "ADDED":
            ...
            self._add_engine(engine_name, engine_ip, model_names, model_label, workspace, endpoint, routing_logic)
